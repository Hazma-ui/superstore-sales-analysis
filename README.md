...
## Overview
This project analyzes a retail superstore dataset to uncover key drivers of sales and profitability, identify inefficiencies, and provide data-driven business recommendations.
...
- The Tables sub-category generates significant losses (~ -50K), indicating structural inefficiency.

- Discounting negatively impacts profitability (correlation: -0.32) and does not significantly increase sales.

- Revenue is widely distributed, with the top 10 customers contributing only ~2.2% of total sales.
